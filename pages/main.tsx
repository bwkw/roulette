    ...
    <>
      <div className='flex h-screen flex-col items-center justify-center bg-gray-100'>
        <div className='flex flex-col md:flex-row md:space-x-4'>
          ...
          <div className='flex flex-col items-center md:w-1/3'>
            <h1 className='my-4 h-12 text-5xl font-bold text-black'>何ポイント？</h1>
            <RoulettePointInput max={300} min={0} point={point} setPoint={setPoint} />
          </div>
        </div>
        <button
          className='mt-12 rounded-xl bg-indigo-600 px-10 py-2 text-xl font-bold text-white shadow-md transition duration-200 ease-in hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 active:bg-indigo-800'
